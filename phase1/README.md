...
```bash
python phase1/week1/verify_setup.py
python phase1/week2/verify_setup.py
python phase1/week3/verify_setup.py
python phase1/week4/verify_setup.py
```
...
进入 [第二阶段（第 5–8 周）](../phase2/)，在 `phase2/` 中选择方向 A / B / C。
